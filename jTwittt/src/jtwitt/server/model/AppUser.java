...
//    @NamedQuery(name = "AppUser.login", query = "SELECT a FROM AppUser a WHERE a.userId = :userId"),
    @NamedQuery(name = "AppUser.login", query = "SELECT a FROM AppUser a WHERE (a.username = :username OR a.email = :username) AND a.password= :password"),
...
public class AppUser implements Serializable {
    ...
    /**
     * Constructor of the AppUser object
     */
    public AppUser() {
    }
    ...
    /**
     * Constructor of the AppUser object
     * @param userId integer the current user is
     */
