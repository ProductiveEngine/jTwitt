...
public class CommunicationThread extends Thread implements Serializable{
    ...
    /**
     * Used to get the current Socket object
     * @return Socket
     */
    ...
    /**
     * Used to get the local variable that is used to distinguish whether it is a client or 
     * a server to be using the communication thread
     * @return boolean
     */
...
//        sock.close();
    ...
    /**
     * Gets the current DataOutputStream
    ...
    /**
     * Assigns the current DataOutputStream
    ...
    /**
     * Gets the current DataInputStream
    ...
    /**
     * Assigns the current DataInputStream
     * to the local variable
     * @param dataIn
     */
    ...
    /**
     * Gets the current ObjectInputStream
    ...
    /**
     * Assigns the current ObjectInputStream
     * to the local variable
     * @param objectIn ObjectInputStream
     */
    ...
    /**
     * Gets the current ObjectOutputStream
    ...
    /**
     * Assigns the current ObjectOutputStream
     * to the local variable
     * @param objectOut
     */
