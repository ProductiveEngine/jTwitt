...
import jtwitt.socket.ServerUpdate;
...
public class ServerDBConnector implements IConnector{
     ...
     * @throws IOException
     */
    public ServerDBConnector(CommunicationThread commThread, ServerUpdate serverUpdate) throws IOException{
    ...
    public int execute(Actions action) throws IOException, ClassNotFoundException{
        ...
        switch(action){
            ...
            case SAVE_TWEET:                
                twBL.saveTweet();
                serverUpdate.setAction(Actions.REFRESH_TWEETS);
                serverUpdate.wakeMe();
                break;
            case REFRESH_TWEETS:                
                twBL.loadTweetList();                
